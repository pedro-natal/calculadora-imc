function calculoIMC() {
  ...
  if (imc < 18.5) {
    resultado(imc, "#26abe3", "abaixo do peso", "./imagens/img1.png");
  } else if (imc >= 18.5 && imc <= 24.9) {
    resultado(imc, "#6b7f36", "no peso normal", "./imagens/img2.png");
  } else if (imc >= 25 && imc <= 29.9) {
    resultado(imc, "#f0a91d", "com excesso de peso", "./imagens/img3.png");
  } else if (imc >= 30 && imc <= 39.9) {
    resultado(imc, "#e9752c", "com obesidade grau 1", "./imagens/img4.png");
  } else {
    resultado(imc, "#d92026", "com obesidade grau 2", "./imagens/img5.png");
  }
}
